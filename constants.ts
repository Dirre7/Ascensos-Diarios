...
export const TRANSLATIONS = {
  en: {
    ...
    auth: {
      ...
      joinUs: "Join Us",
      syncDesc: "Sync your progress",
      joinDesc: "Start your journey",
      email: "Email",
      password: "Password",
      signIn: "Sign In",
      ...
      createAction: "Create an account",
      signInAction: "Sign in to existing account",
      success: "Registration successful! Check your email to confirm.",
      emailPlaceholder: "hello@dailyascensions.app"
    },
    habits: {
  ...
  es: {
    ...
    auth: {
      ...
      joinUs: "Únete",
      syncDesc: "Sincroniza tu progreso",
      joinDesc: "Comienza tu viaje",
      email: "Correo",
      password: "Contraseña",
      signIn: "Iniciar Sesión",
      createAccount: "Crear Cuenta",
      newHere: "¿Eres nuevo?",
      alreadyJoined: "¿Ya tienes cuenta?",
      createAction: "Crear una cuenta",
      signInAction: "Ingresar a mi cuenta",
      success: "¡Registro exitoso! Revisa tu correo para confirmar.",
      emailPlaceholder: "hola@ascensosdiarios.app"
    },
    habits: {
